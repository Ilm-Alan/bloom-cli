...
from bloom.core.agents.models import BUILTIN_AGENTS, AgentType
from bloom.core.tools.base import BaseToolState, InvokeContext, ToolError
from bloom.core.tools.builtins.task import Task, TaskArgs, TaskResult, TaskToolConfig
from bloom.core.types import AssistantEvent, LLMMessage, Role
...
class TestTaskToolExecution:
    ...
    async def test_happy_path_returns_subagent_response(
        ...
        with patch("bloom.core.tools.builtins.task.AgentLoop") as mock_agent_loop_class:
