...
from bloom.core import run_programmatic
...
def test_run_programmatic_preload_streaming_is_batched(
    ...
    monkeypatch.setattr(
        "bloom.core.programmatic.create_formatter", lambda *_args, **_kwargs: spy
    )
    ...
    with mock_backend_factory(
        ...
        assert (
            spy.emitted[0][1] == "You are Bloom, a super useful programming assistant."
        )
