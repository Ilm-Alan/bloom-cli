...
from bloom.core.types import FunctionCall, LLMMessage, Role, ToolCall
from tests.conftest import (
    build_test_agent_loop,
    build_test_bloom_app,
    build_test_bloom_config,
)
...
async def test_ui_displays_messages_when_resuming_session(
    ...
    agent_loop = build_test_agent_loop(config=bloom_config)
    ...
    app = build_test_bloom_app(agent_loop=agent_loop)
...
async def test_ui_rebuilds_history_when_whats_new_is_shown(
    ...
    monkeypatch.setenv("POLLINATIONS_API_KEY", "api-key")
    config = build_test_bloom_config(enable_update_checks=True)
