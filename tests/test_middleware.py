...
from bloom.core.agents.models import BUILTIN_AGENTS, AgentProfile, BuiltinAgentName
...
from bloom.core.types import AgentStats


@pytest.fixture
def ctx(bloom_config: BloomConfig) -> ConversationContext:
    return ConversationContext(messages=[], stats=AgentStats(), config=bloom_config)
