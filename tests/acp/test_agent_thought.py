...
from bloom.core.types import LLMChunk, LLMMessage, LLMUsage, Role
...
def acp_agent_loop_with_reasoning(
    ...
    config = build_test_bloom_config(active_model="glm-5")
...
class TestACPAgentThought:
    ...
    async def test_prompt_with_reasoning_emits_agent_thought_chunk(
        self, acp_agent_loop_with_reasoning: BloomAcpAgentLoop
    ) -> None:
