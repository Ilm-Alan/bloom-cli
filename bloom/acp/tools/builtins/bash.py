...
from bloom.acp.tools.base import AcpToolState, BaseAcpTool
from bloom.core.tools.base import BaseToolState, InvokeContext, ToolError
from bloom.core.tools.builtins.bash import Bash as CoreBashTool, BashArgs, BashResult
from bloom.core.types import ToolCallEvent, ToolResultEvent, ToolStreamEvent
...
class Bash(CoreBashTool, BaseAcpTool[AcpBashState]):
    prompt_path = BLOOM_ROOT / "core" / "tools" / "builtins" / "prompts" / "bash.md"
    state: AcpBashState
