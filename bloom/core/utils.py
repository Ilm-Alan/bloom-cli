...
from bloom.core.paths.global_paths import LOG_DIR, LOG_FILE
from bloom.core.types import BaseEvent, ToolResultEvent

CANCELLATION_TAG = "user_cancellation"
TOOL_ERROR_TAG = "tool_error"
BLOOM_STOP_EVENT_TAG = "bloom_stop_event"
BLOOM_WARNING_TAG = "bloom_warning"

KNOWN_TAGS = [CANCELLATION_TAG, TOOL_ERROR_TAG, BLOOM_STOP_EVENT_TAG, BLOOM_WARNING_TAG]
