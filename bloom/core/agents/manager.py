...
from bloom.core.paths.config_paths import resolve_local_agents_dir
from bloom.core.paths.global_paths import GLOBAL_AGENTS_DIR
...
class AgentManager:
    def __init__(
        self,
        config_getter: Callable[[], BloomConfig],
        ...
        self._cached_config: BloomConfig | None = None
