...
from bloom.core.trusted_folders import has_trustable_content, trusted_folders_manager
from bloom.setup.trusted_folders.trust_folder_dialog import (
...
def parse_arguments() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the Bloom interactive CLI")
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        "or custom from ~/.bloom/agents/NAME.toml)",
    )
    parser.add_argument(
        "--model",
        type=str,
...
def check_and_resolve_trusted_folder() -> None:
    try:
        ...
        rprint(
            ...
            "[yellow]The directory you started bloom from has been deleted. "
...
def main() -> None:
    ...
    from bloom.cli.cli import run_cli
