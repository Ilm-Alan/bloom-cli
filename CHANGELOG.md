...
- Initial Bloom release at version `0.1.0`
...
- Refactored UI to require AgentLoop at BloomApp construction
...
- bash tool not discovered by bloom-acp
...
- Auto update editor extension on release creation
...
- Modular mode system
- Trusted folder mechanism for local .bloom directories
- Document public setup for bloom-acp in multiple IDEs
- `--version` flag
...
- Rename extension agent identifier to bloom-cli

### Fixed

- Fix icon and description in extension package metadata
...
- Add LICENCE symlink in extension packaging for compatibility

## [1.0.2] - 2025-12-09

### Fixed

- Fix setup flow for bloom-acp builds
